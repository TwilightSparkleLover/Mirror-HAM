...
int main(void)
{
   ...
   while(1)
   {
       ...
       if(g_NewFrame)
       {
           ...
           ham_DrawText(4,2,"Hold A button to flip");
           
           // Get joypad input
           if(F_CTRLINPUT_A_PRESSED)
           {
               ham_SetObjHFlip(g_SprObj,        // The OBJ number of which you want to modify
                               1);              // 0 = no flip 1 = flip
               ham_SetObjVFlip(g_SprObj,        // The OBJ number of which you want to modify
                               1);              // 0 = no flip 1 = flip
           }
           else
           {
