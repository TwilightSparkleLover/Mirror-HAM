...
NOTE: for detailed info about aPLib check http://home19.inet.tele.dk/jibz/apack/
      thanks to J°rgen Ibsen for this excellent piece of software
...
A: added ProMotion .spr loader
   ...
   added possibility to have a ' ' (space) between argument and parameter (Krystian
W.)
   added -align option to add  __attribute__ ((aligned (4))) to C/C++ arrays (Thomas
H.)
